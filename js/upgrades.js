Upgrades = {
  ...
  Upgrade : function(id, name, type, costType, basePrice, multiplier, effect, cap, description) {
    this.id = id;
    this.name = name;
    this.type = type;
...
Upgrades.upgrades = [
  // blood upgrades
  new Upgrades.Upgrade(1, "Bloodthirst", Upgrades.types.damage, Upgrades.costs.blood, 50, 1.5, 1, 100, "Your zombies thirst for blood and do +1 damage for each rank of Bloodthirst."),
  ...
  new Upgrades.Upgrade(6, "Cursed Graveyard", Upgrades.types.graveyard, Upgrades.costs.blood, 2000, 1, 1, 1, "Construct a Cursed Graveyard in the town that will automatically spawn zombies when your energy is at its maximum!"),

  // brain upgrades
  new Upgrades.Upgrade(20, "Energy Rush", Upgrades.types.energyRate, Upgrades.costs.brains, 25, 2, 0.5, 15, "Melting brains down in your cauldron to make smoothies can be beneficial for your health. It also increases your energy rate by 0.5 per second for each rank."),
  new Upgrades.Upgrade(21, "Master Summoner", Upgrades.types.energyCap, Upgrades.costs.brains, 10, 1.5, 5, 100, "All the brains you harvested have proved fruitful in your experiments. Each rank raises your maximum energy by 5."),
  new Upgrades.Upgrade(22, "Primal Reflexes", Upgrades.types.speed, Upgrades.costs.brains, 5, 2, 1, 50, "The zombies retain more of their human agility increasing run speed by 1 for each rank."),
  ...
  // bone upgrades
  new Upgrades.Upgrade(40, "Bone Throne", Upgrades.types.energyCap, Upgrades.costs.bones, 50, 2, 10, 10, "Sitting atop your throne of bones you can finally think clearly. Each rank increases maximum energy by 10."),
  ...
  new Upgrades.Upgrade(42, "Bonebarrows", Upgrades.types.boneCollectorCapacity, Upgrades.costs.bones, 300, 1.5, 5, 20, "Your bone collectors are struggling to carry all these bones. Maybe it's time we gave them an upgrade? Each rank increases their carrying capacity by 5."),
  new Upgrades.Upgrade(43, "Bone Reinforced Blood Tanks", Upgrades.types.bloodCap, Upgrades.costs.bones, 500, 1.1, 2000, 50, "Finally! Now that we have a solid construction material we can get to work building better storage for our other resources. Each rank increases blood storage by 2000."),
  new Upgrades.Upgrade(44, "Brain Cage", Upgrades.types.brainsCap, Upgrades.costs.bones, 650, 1.1, 500, 50, "There's nothing I love more than a mind enslaved. Now we can put these brains where they belong. In cages! Each rank increases brain storage by 200."),
];
